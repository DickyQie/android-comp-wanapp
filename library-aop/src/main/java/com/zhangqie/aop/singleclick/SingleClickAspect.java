package com.zhangqie.aop.singleclick;

import android.content.res.Resources;
import android.view.View;

import com.zhangqie.aop.singleclick.annotation.SingleClick;
...
public class SingleClickAspect {
    ...
    private static final String POINTCUT_SINGLE_CLICK =
            "execution(@com.zhangqie.aop.singleclick.annotation.SingleClick * *(..))";
